...
export default function Card({issue}) {
    ...
    return (
    <>
        <div className = "transition-all flex flex-col duration-200 w-full h-full p-5 mt-5 ml-5 mr-5 border-solid border-2 border-black rounded-lg cursor-pointer group bg-white hover:bg-hover-gray hover:border-blue">
